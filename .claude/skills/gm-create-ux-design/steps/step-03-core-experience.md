...
- Invoke the `gm-advanced-elicitation` skill with the current core experience content
...
- Invoke the `gm-party-mode` skill with the current core experience definition
