...
- Invoke the `gm-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `gm-party-mode` skill with the current emotional response definition
