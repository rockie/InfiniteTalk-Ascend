...
- Invoke the `gm-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `gm-party-mode` skill with the current inspiration analysis
