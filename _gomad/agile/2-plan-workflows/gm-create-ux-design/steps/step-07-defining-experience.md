...
- Invoke the `gm-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `gm-party-mode` skill with the current defining experience
