...
- Invoke the `gm-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `gm-party-mode` skill with the current responsive/accessibility strategy
